...
class BookingSchedulerTest {
    ...
    private static final LocalDateTime NOW = LocalDateTime.of(2026, Month.JUNE, 5, 9, 20);
    ...
    void releaseExpiredLocks_marksExpired_andNotifies() {
        ...
        Booking stale = new Booking(user, room,
                new com.example.meetingroom.domain.TimeRange(LocalDateTime.of(2026, Month.JUNE, 5, 11, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 11, 30)), BookingStatus.LOCKING);
