...
class BookingRepositoryTest {
    ...
    void findOverlapping_detectsIntersectingActiveBooking() {
        ...
        persistBooking(LocalDateTime.of(2026, Month.JUNE, 5, 14, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 15, 0), BookingStatus.BOOKED);
        ...
        List<Booking> overlap = bookingRepository.findOverlapping(roomA.getId(),
                new com.example.meetingroom.domain.TimeRange(LocalDateTime.of(2026, Month.JUNE, 5, 14, 30),
                LocalDateTime.of(2026, Month.JUNE, 5, 15, 30)),
    ...
    void findOverlapping_treatsTouchingEdgesAsFree() {
        ...
        assertThat(bookingRepository.findOverlapping(roomA.getId(),
                new com.example.meetingroom.domain.TimeRange(LocalDateTime.of(2026, Month.JUNE, 5, 15, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 16, 0)),
                BookingStatus.activeStatuses())).isEmpty();

        // 新增一個預約單預約 2026/6/5 13:00~14:00，預期是空的可以預約
        assertThat(bookingRepository.findOverlapping(roomA.getId(),
                new com.example.meetingroom.domain.TimeRange(LocalDateTime.of(2026, Month.JUNE, 5, 13, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 14, 0)),
                BookingStatus.activeStatuses())).isEmpty();
    }
    ...
    void findOverlapping_ignoresCancelledAndExpired() {
        ...
        persistBooking(LocalDateTime.of(2026, Month.JUNE, 5, 14, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 15, 0), BookingStatus.CANCELLED);
        // 存在一個預約成功單 2026/6/5 14:00–15:00. 狀態是 EXPIRED(沒報到)
        persistBooking(LocalDateTime.of(2026, Month.JUNE, 5, 14, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 15, 0), BookingStatus.EXPIRED);

        // 新增一個預約單預約 2026/6/5 14:00–15:00，預期是空的可以預約
        assertThat(bookingRepository.findOverlapping(roomA.getId(),
                new com.example.meetingroom.domain.TimeRange(LocalDateTime.of(2026, Month.JUNE, 5, 14, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 15, 0)),
                BookingStatus.activeStatuses())).isEmpty();
    }
    ...
    void findOverlappingExcluding_skipsTheBookingItself() {
        ...
        Booking self = persistBooking(LocalDateTime.of(2026, Month.JUNE, 5, 14, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 15, 0), BookingStatus.LOCKING);
    ...
    void findExpiredLocks_returnsOnlyTimedOutLocks() {
        ...
        Booking stale = persistBooking(LocalDateTime.of(2026, Month.JUNE, 5, 16, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 16, 30), BookingStatus.LOCKING);
        // 設定截止時間是 2026/6/5 09:00
        stale.setLockExpiresAt(LocalDateTime.of(2026, Month.JUNE, 5, 9, 0));
        // 呼叫 save 更新資料庫
        bookingRepository.save(stale);

        // 09:01 findExpiredLocks 尋找截止的預約
        List<Booking> expired = bookingRepository.findExpiredLocks(LocalDateTime.of(2026, Month.JUNE, 5, 9, 1));
    ...
    void findNoShows_returnsBookedStartedBeyondThreshold() {
        ...
        Booking noShow = persistBooking(LocalDateTime.of(2026, Month.JUNE, 5, 9, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 9, 30), BookingStatus.BOOKED);
        // 一筆預約單，2026/6/5 09:00–09:30，狀態是 CHECKED_IN
        persistBooking(LocalDateTime.of(2026, Month.JUNE, 5, 9, 0),
                LocalDateTime.of(2026, Month.JUNE, 5, 9, 30), BookingStatus.CHECKED_IN);
        // 排程器 9:16 看是否有未報到的
        List<Booking> result = bookingRepository.findNoShows(LocalDateTime.of(2026, Month.JUNE, 5, 9, 16));
